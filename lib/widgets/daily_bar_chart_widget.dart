...
class DailyBarChartWidget extends StatefulWidget {
  const DailyBarChartWidget({Key? key, required this.data}) : super(key: key);
  final BucketList data;

  @override
  State<StatefulWidget> createState() => DailyBarChartWidgetState();
}

class DailyBarChartWidgetState extends State<DailyBarChartWidget> {
  @override
  Widget build(BuildContext context) {
    return AspectRatio(
      aspectRatio: 1.7,
